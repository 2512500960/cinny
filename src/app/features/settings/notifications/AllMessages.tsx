  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('Pages.Settings.Notifications.all_messages')}</Text>
        <Box gap="100">
      ...
      >
        <SettingTile
          title={t('Pages.Settings.Notifications.all_messages_1to1')}
      ...
      >
        <SettingTile
          title={t('Pages.Settings.Notifications.all_messages_1to1_encrypted')}
          after={
      ...
      >
        <SettingTile
          title={t('Pages.Settings.Notifications.all_messages_rooms')}
      ...
      >
        <SettingTile
          title={t('Pages.Settings.Notifications.all_messages_rooms_encrypted')}
          after={
            <AllMessagesModeSwitcher
              pushRules={pushRules}
