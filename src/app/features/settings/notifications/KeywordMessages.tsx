  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('Pages.Settings.KeywordMessages.title')}</Text>
        <Box gap="100">
          <Text size="T200">{t('Pages.Settings.KeywordMessages.badge_label')}</Text>
      ...
      >
        <SettingTile
          title={t('Pages.Settings.KeywordMessages.select_keyword')}
          description={t('Pages.Settings.KeywordMessages.select_keyword_desc')}
        >
          <KeywordInput />
        </SettingTile>
      </SequenceCard>
