        ...
        <Scroll hideTrack visibility="Hover">
          <PageContent>
            <Box direction="Column" gap="700">
              <Box direction="Column" gap="100">
                <Text size="L400">{t('Pages.Devices.security')}</Text>
                <SequenceCard
                ...
                >
                  <SettingTile
                    title={t('Pages.Devices.device_verification')}
                    description={t('Pages.Devices.device_verification_desc')}
                    after={
                      <>
              ...
              <Box direction="Column" gap="100">
                <Text size="L400">{t('Pages.Devices.current')}</Text>
                {currentDevice ? (
                  <SequenceCard
                    className={SequenceCardStyle}
                    variant="SurfaceVariant"
