  ...
  return (
    <Box direction="Column" gap="100">
      {creators.size > 0 && (
        ...
        >
          <SettingTile
            title={t('Pages.RoomSettings.Powers.founders')}
            description={t('Pages.RoomSettings.Powers.founders_desc')}
          />
      ...
      >
        <SettingTile
          title={t('Pages.RoomSettings.Powers.title')}
          description={t('Pages.RoomSettings.Powers.desc')}
          after={
            onEdit && (
              <Box gap="200">
                <Button
