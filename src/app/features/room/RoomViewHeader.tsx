        ...
        <UseStateProvider initial={false}>
          {(promptJump, setPromptJump) => (
            <>
              ...
              >
                <Text style={{ flexGrow: 1 }} as="span" size="T300" truncate>
                  {t('Pages.RoomViewHeader.jump_to_time')}
                </Text>
              </MenuItem>
              {promptJump && (
                <JumpToTime
        ...
        <Box shrink="No">
          {!ecryptedRoom && (
            <TooltipProvider
              ...
              tooltip={
                <Tooltip>
                  <Text>{t('Pages.RoomViewHeader.search')}</Text>
                </Tooltip>
              }
            >
              {(triggerRef) => (
          ...
          <TooltipProvider
            ...
            tooltip={
              <Tooltip>
                <Text>{t('Pages.RoomViewHeader.pinned_messages')}</Text>
              </Tooltip>
            }
          >
            {(triggerRef) => (
            ...
            <TooltipProvider
              ...
              tooltip={
                <Tooltip>
                  <Text>
                    {peopleDrawer
                      ? t('Pages.RoomViewHeader.hide_members')
                      : t('Pages.RoomViewHeader.show_members')}
                  </Text>
                </Tooltip>
              }
            >
          ...
          <TooltipProvider
            ...
            tooltip={
              <Tooltip>
                <Text>{t('Pages.RoomViewHeader.more_options')}</Text>
              </Tooltip>
            }
          >
            {(triggerRef) => (
