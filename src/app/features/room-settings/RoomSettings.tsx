    ...
    () => [
      {
        ...
        name: t('Pages.RoomSettings.menu.general'),
        icon: Icons.Setting,
      },
      {
        page: RoomSettingsPage.MembersPage,
        name: t('Pages.RoomSettings.menu.members'),
        icon: Icons.User,
      },
      {
        page: RoomSettingsPage.PermissionsPage,
        name: t('Pages.RoomSettings.menu.permissions'),
        icon: Icons.Lock,
      },
      {
        page: RoomSettingsPage.EmojisStickersPage,
        name: t('Pages.RoomSettings.menu.emojis_stickers'),
        icon: Icons.Smile,
      },
      {
        page: RoomSettingsPage.DeveloperToolsPage,
        name: t('Pages.RoomSettings.menu.developer_tools'),
        icon: Icons.Terminal,
      },
    ],
    [t]
