  ...
  return (
    <Box as="form" onSubmit={handleSubmit} grow="Yes" direction="Column" gap="500">
      <Box direction="Column" gap="100">
        <Text size="L400">{t('Pages.CreateRoom.access')}</Text>
        <CreateRoomKindSelector
          value={kind}
          onSelect={setKind}
      ...
      <Box shrink="No" direction="Column" gap="100">
        <Text size="L400">{t('Pages.CreateRoom.name')}</Text>
        <Input
          required
      ...
      <Box shrink="No" direction="Column" gap="100">
        <Text size="L400">{t('Pages.CreateRoom.topic_optional')}</Text>
        <TextArea
          name="topicTextAria"
          size="500"
          variant="SurfaceVariant"
      ...
      <Box shrink="No" direction="Column" gap="100">
        <Box gap="200" alignItems="End">
          <Text size="L400">{t('Pages.CreateRoom.options')}</Text>
          <Box grow="Yes" justifyContent="End">
            <Chip
              ...
              type="button"
            >
              <Text size="T200">{t('Pages.CreateRoom.advanced_options')}</Text>
            </Chip>
          </Box>
        </Box>
        ...
        {kind !== CreateRoomKind.Public && (
          <>
            ...
            >
              <SettingTile
                title={t('Pages.CreateRoom.e2ee_title')}
                description={t('Pages.CreateRoom.e2ee_desc')}
                after={
                  <Switch
                    variant="Primary"
                    value={encryption}
            ...
            {advance && (allowKnock || allowKnockRestricted) && (
              ...
              >
                <SettingTile
                  title={t('Pages.CreateRoom.knock_title')}
                  description={t('Pages.CreateRoom.knock_desc')}
                  after={
                    <Switch
                      variant="Primary"
                      value={knock}
        ...
        >
          <SettingTile
            title={t('Pages.CreateRoom.allow_federation_title')}
            description={t('Pages.CreateRoom.allow_federation_desc')}
            after={
              <Switch
                variant="Primary"
                value={federation}
      ...
      <Box shrink="No" direction="Column" gap="200">
        ...
        >
          <Text size="B500">{t('Pages.CreateRoom.create')}</Text>
        </Button>
      </Box>
    </Box>
  );
