        ...
        {canEdit && (
          <Box gap="200">
            <Chip
              ...
              outlined
            >
              <Text size="B300">{t('Pages.ImagePack.edit')}</Text>
            </Chip>
          </Box>
        )}
      </Box>
    ...
    <Box as="form" onSubmit={handleSubmit} direction="Column" gap="400">
      <Box gap="400">
        <Box grow="Yes" direction="Column" gap="100">
          <Text size="L400">{t('Pages.ImagePack.pack_avatar')}</Text>
          {uploadAtom ? (
      ...
      <Box direction="Inherit" gap="100">
        <Text size="L400">{t('Pages.ImagePack.name')}</Text>
        <Input name="nameInput" defaultValue={meta.name} variant="Secondary" radii="300" required />
      </Box>
      <Box direction="Inherit" gap="100">
        <Text size="L400">{t('Pages.ImagePack.attribution')}</Text>
        <TextArea
