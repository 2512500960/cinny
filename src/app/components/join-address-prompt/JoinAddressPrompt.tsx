      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">{t('Pages.JoinAddress.title')}</Text>
              </Box>
            ...
            >
              <Box direction="Column" gap="200">
                <Text priority="400" size="T300">
                  {t('Pages.JoinAddress.instructions')}
                </Text>
              ...
              <Box direction="Column" gap="100">
                <Text size="L400">{t('Pages.JoinAddress.address_label')}</Text>
                <Input
                  size="500"
                  autoFocus
                  name="addressInput"
                ...
                {invalid && (
                  <Text size="T200" style={{ color: color.Critical.Main }}>
                    <b>{t('Pages.JoinAddress.invalid_address')}</b>
                  </Text>
                )}
              </Box>
              <Button type="submit" variant="Primary">
                <Text size="B400">{t('Pages.JoinAddress.open')}</Text>
              </Button>
            </Box>
          </Dialog>
        </FocusTrap>
