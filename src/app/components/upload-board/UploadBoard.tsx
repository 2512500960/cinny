  ...
  return (
    <Header size="400">
      ...
      >
        ...
        <Text size="H6">{t('Pages.UploadBoard.files')}</Text>
      </Box>
      <Box className={css.UploadBoardHeaderContent} alignItems="Center" gap="100">
        {isSuccess && (
          ...
          >
            <Text size="B300">{t('Pages.UploadBoard.send')}</Text>
          </Chip>
        )}
        {isError && !open && (
          <Badge variant="Critical" fill="Solid" radii="300">
            <Text size="L400">{t('Pages.UploadBoard.upload_failed')}</Text>
          </Badge>
        )}
        ...
        {!isSuccess && open && (
          ...
          >
            <Text size="B300">
              {uploads.length === 1
                ? t('Pages.UploadBoard.remove')
                : t('Pages.UploadBoard.remove_all')}
            </Text>
          </Chip>
        )}
      </Box>
