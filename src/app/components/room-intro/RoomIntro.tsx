      ...
      <Box direction="Column" gap="300">
        <Box direction="Column" gap="100">
          ...
          <Text size="T400" priority="400">
            {typeof topic === 'string' ? topic : t('Pages.RoomIntro.no_topic')}
          </Text>
          {creatorName && ts && (
        ...
        <Box gap="200" wrap="Wrap">
          <Button onClick={() => setInvitePrompt(true)} variant="Secondary" size="300" radii="300">
            <Text size="B300">{t('Pages.RoomIntro.invite_member')}</Text>
          </Button>
          ...
          {typeof prevRoomId === 'string' &&
            (mx.getRoom(prevRoomId)?.getMyMembership() === Membership.Join ? (
              <Button
                ...
                radii="300"
              >
                <Text size="B300">{t('Pages.RoomIntro.open_old_room')}</Text>
              </Button>
            ) : (
              <Button
              ...
              >
                <Text size="B300">{t('Pages.RoomIntro.join_old_room')}</Text>
              </Button>
            ))}
        </Box>
      </Box>
