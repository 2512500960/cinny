...
const useRoomNotificationModeStr = (): Record<RoomNotificationMode, string> => {
  ...
  return useMemo(
    () => ({
      [RoomNotificationMode.Unset]: t('Pages.RoomNotificationSwitcher.default'),
      [RoomNotificationMode.AllMessages]: t('Pages.RoomNotificationSwitcher.all_messages'),
      [RoomNotificationMode.SpecialMessages]: t('Pages.RoomNotificationSwitcher.mention_keywords'),
      [RoomNotificationMode.Mute]: t('Pages.RoomNotificationSwitcher.mute'),
    }),
    [t]
  );
};
