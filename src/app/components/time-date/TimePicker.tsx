    ...
    return (
      <Menu className={css.PickerMenu} ref={ref}>
        <Box direction="Row" gap="200" className={css.PickerContainer}>
          <PickerColumn title={t('Pages.TimePicker.hour')}>
            {hour24Clock
          ...
          <PickerColumn title={t('Pages.TimePicker.minutes')}>
          ...
          {!hour24Clock && (
            <PickerColumn title={t('Pages.TimePicker.period')}>
              <Chip
                size="500"
              ...
              >
                <Text size="T300">{t('Pages.TimePicker.am')}</Text>
              </Chip>
              <Chip
                size="500"
                variant={selectedPM ? 'Primary' : 'SurfaceVariant'}
              ...
              >
                <Text size="T300">{t('Pages.TimePicker.pm')}</Text>
              </Chip>
            </PickerColumn>
          )}
        </Box>
