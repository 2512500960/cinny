  ...
  if (
    ...
    return (
      <Box direction="Column" shrink="No">
        ...
        >
          <Text size="L400">{t('Pages.SyncStatus.connecting')}</Text>
        </Box>
    ...
    return (
      <Box direction="Column" shrink="No">
        <Box
          ...
          justifyContent="Center"
        >
          <Text size="L400">{t('Pages.SyncStatus.reconnecting')}</Text>
        </Box>
    ...
    return (
      <Box direction="Column" shrink="No">
        <Box
          ...
          justifyContent="Center"
        >
          <Text size="L400">{t('Pages.SyncStatus.connection_lost')}</Text>
        </Box>
