...
export function CreateTab() {
  ...
  return (
    <SidebarItem active={createSelected}>
      <SidebarItemTooltip tooltip={t('Pages.CreateTab.add_space')}>
        {(triggerRef) => (
          <PopOut
            anchor={menuCords}
            position="Right"
                  ...
                  <Box direction="Column">
                    ...
                    >
                      <SettingTile before={<Icon size="400" src={Icons.Space} />}>
                        <Text size="H6">{t('Pages.CreateTab.create_space')}</Text>
                        <Text size="T300" priority="300">
                          {t('Pages.CreateTab.build_space_for_community')}
                        </Text>
                      </SettingTile>
                    </SequenceCard>
                    <SequenceCard
                    ...
                    >
                      <SettingTile before={<Icon size="400" src={Icons.Link} />}>
                        <Text size="H6">{t('Pages.CreateTab.join_with_address')}</Text>
                        <Text size="T300" priority="300">
                          {t('Pages.CreateTab.become_part_of_existing_community')}
                        </Text>
                      </SettingTile>
                    </SequenceCard>
                  </Box>
