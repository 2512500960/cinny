  ...
  const renderMatrixEvent = useMatrixEventRenderer<[IRoomEvent, string, GetContentCallback]>(
    {
      ...
      [StateEvent.RoomTombstone]: (event) => {
        ...
        return (
          <Box grow="Yes" direction="Column">
            <Text size="T400" priority="300">
              {t('Pages.Notifications.room_tombstone_prefix')} {content.body}
            </Text>
          </Box>
        );
      },
      ...
      <Header size="300">
        ...
        <Box shrink="No">
          {unread && (
            ...
            >
              <Text size="T200">{t('Pages.Notifications.mark_as_read')}</Text>
            </Chip>
          )}
        </Box>
      </Header>
                ...
                <Box gap="300" justifyContent="SpaceBetween" alignItems="Center" grow="Yes">
                  ...
                  <Box shrink="No" gap="200" alignItems="Center">
                    <Chip
                      ...
                      radii="400"
                    >
                      <Text size="T200">{t('Pages.Notifications.open')}</Text>
                    </Chip>
                  </Box>
                </Box>
                {replyEventId && (
              ...
              <Box direction="Column" gap="200">
                <Box ref={scrollTopAnchorRef} direction="Column" gap="100">
                  ...
                  <Box gap="200">
                    <Chip
                      ...
                      outlined
                    >
                      <Text size="T200">{t('Pages.Notifications.all_notifications')}</Text>
                    </Chip>
                    <Chip
                      ...
                      outlined
                    >
                      <Text size="T200">{t('Pages.Notifications.highlighted')}</Text>
                    </Chip>
                  </Box>
                </Box>
                <ScrollTopContainer
                ...
                >
                  <IconButton
                    ...
                    outlined
                    size="300"
                    aria-label={t('Pages.Notifications.scroll_to_top')}
                  >
                ...
                {timelineState.status === AsyncStatus.Success &&
                  notificationTimeline.groups.length === 0 && (
                    <Box
                      ...
                      gap="200"
                    >
                      <Text>{t('Pages.Notifications.no_notifications')}</Text>
                      <Text size="T200">{t('Pages.Notifications.no_notifications_desc')}</Text>
                    </Box>
                  )}
