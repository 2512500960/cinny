  ...
  return (
    ...
    >
          ...
          {invite.isEncrypted && (
            <Box shrink="No" alignItems="Center" justifyContent="Center">
              <Badge variant="Success" fill="Solid" size="400" radii="300">
                <Text size="L400">{t('Pages.Invites.encrypted')}</Text>
              </Badge>
            </Box>
          )}
          {invite.isDirect && (
            <Box shrink="No" alignItems="Center" justifyContent="Center">
              <Badge variant="Primary" fill="Solid" size="400" radii="300">
                <Text size="L400">{t('Pages.Invites.direct_message')}</Text>
              </Badge>
            </Box>
          )}
          {invite.isSpace && (
            <Box shrink="No" alignItems="Center" justifyContent="Center">
              <Badge variant="Secondary" fill="Soft" size="400" radii="300">
                <Text size="L400">{t('Pages.Invites.space')}</Text>
              </Badge>
            </Box>
          )}
        </Box>
      ...
      <Box gap="300">
        ...
        <Box direction={compact ? 'Column' : 'Row'} grow="Yes" gap="200">
          ...
          <Box gap="200" shrink="No" alignItems="Center">
            ...
            >
              <Text size="B300">{t('Pages.Invites.decline')}</Text>
            </Button>
            <Button
              onClick={join}
              size="300"
            ...
            >
              <Text size="B300">{t('Pages.Invites.accept')}</Text>
            </Button>
          </Box>
        </Box>
      </Box>
      <Box direction="Column">
        <Box gap="200" alignItems="Baseline">
          <Box grow="Yes">
            <Text size="T200" priority="300">
              {t('Pages.Invites.from_prefix')} <b>{invite.senderId}</b>
            </Text>
          </Box>
        ...
        {invite.reason && (
          <Text size="T200" priority="300">
            {t('Pages.Invites.reason_prefix')} {invite.reason}
          </Text>
        )}
      </Box>
    </SequenceCard>
...
function InviteFilters({
  ...
  return (
    <Box gap="200">
      ...
      >
        <Text size="T200">{t('Pages.Invites.primary')}</Text>
      </Chip>
      <Chip
      ...
      >
        <Text size="T200">{t('Pages.Invites.public')}</Text>
      </Chip>
      <Chip
      ...
      >
        <Text size="T200">{t('Pages.Invites.spam')}</Text>
      </Chip>
    </Box>
  );
}
...
function KnownInvites({
  ...
  return (
    <Box direction="Column" gap="200">
      <Text size="H4">{t('Pages.Invites.primary')}</Text>
      {invites.length > 0 ? (
        ...
        <PageHeroEmpty>
          <PageHeroSection>
            <PageHero
              ...
              title={t('Pages.Invites.no_invites_title')}
              subTitle={t('Pages.Invites.no_invites_subtitle')}
            />
          </PageHeroSection>
        </PageHeroEmpty>
      )}
  ...
  return (
    <Box direction="Column" gap="200">
      <Box gap="200" justifyContent="SpaceBetween" alignItems="Center">
        <Text size="H4">{t('Pages.Invites.public')}</Text>
        <Box>
          {invites.length > 0 && (
            <Chip
              variant="SurfaceVariant"
              ...
              radii="Pill"
            >
              <Text size="T200">{t('Pages.Invites.decline_all')}</Text>
            </Chip>
          )}
        </Box>
      </Box>
...
function SpamInvites({
  ...
  return (
    <Box direction="Column" gap="200">
      <Text size="H4">{t('Pages.Invites.spam')}</Text>
      {invites.length > 0 ? (
        <Box direction="Column" gap="100">
          <SequenceCard
            variant="SurfaceVariant"
          ...
          >
            <PageHeroSection>
              <PageHero
                ...
                title={t('Pages.Invites.spam_count', { count: invites.length })}
                subTitle={t('Pages.Invites.spam_subtitle')}
              >
                ...
                >
                  <Text size="B300">
                    {showInvites ? t('Pages.Invites.hide_all') : t('Pages.Invites.view_all')}
                  </Text>
                </Button>
              </PageHero>
            </PageHeroSection>
        ...
        <PageHeroEmpty>
          <PageHeroSection>
            <PageHero
              icon={<Icon size="600" src={Icons.Warning} />}
              title={t('Pages.Invites.no_spam_invites')}
              subTitle={t('Pages.Invites.no_spam_invites_subtitle')}
            />
          </PageHeroSection>
        </PageHeroEmpty>
      )}
          ...
          <PageContent>
            <PageContentCenter>
              <Box ref={containerRef} direction="Column" gap="600">
                <Box direction="Column" gap="100">
                  <span data-spacing-node />
                  <Text size="L400">{t('Pages.Invites.filter')}</Text>
                  <InviteFilters
                    filter={filter}
                    onFilter={setFilter}
