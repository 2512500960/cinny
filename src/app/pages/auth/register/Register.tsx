  ...
  return (
    <Box direction="Column" gap="500">
      ...
      <Text align="Center">
        ...
        <Link to={getLoginPath(server)}>{t('Pages.Register.login')}</Link>
      </Text>
    </Box>
  );
}
